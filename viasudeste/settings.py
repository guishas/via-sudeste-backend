"""
Django settings for viasudeste project.
...
INSTALLED_APPS = [
    ...
    'viasudesteapp.apps.ViasudesteappConfig',
    'rest_framework',
...
WSGI_APPLICATION = 'viasudeste.wsgi.application'
...
EMAIL_HOST_PASSWORD = 'eoawtxofrrejfijw'
